...
const useStyles = makeStyles({
    ...
    root:{
        backgroundColor:'#263238'// 'transparent', //'#fff'
    },
    changed:{
        ...
        <Toolbar disableGutters variant='dense'> 
             <Grid container alignItems='center'>
                ...
                <Grid item  sm={6} style={{display:'flex'}}>
                    ...
                    { localStorageData ===null && <Typography variant='h6' component={Link} to='/signup' className={classes.menu}>Log in</Typography>}

                    <Typography variant='h6' component={Link} to='/gallery'  className={classes.menu}>Gallery</Typography>
                    <Typography variant='h6' component={Link} to='/about'  className={classes.menu}>FaQs</Typography>  

                    {localStorageData !==null && 
                    <>
                    <Typography variant='h6' component={Link} to='/account'  className={classes.menu}>Account</Typography>                
                    <Typography variant='h6'  className={classes.menu} onClick={()=>{dispatch({type:'LOGOUT'}); navigate('/')}}>Logout</Typography>                  
                    </>
                    }
                    <Typography variant='h6' component={Link} to='/store'  className={classes.menu}><div style={{color:'orange',fontWeight:'600',fontStyle:'italic'}}>Check out our Store !</div></Typography> 
                </Grid>
                <Grid item sm={4}> 
                    <Grid container>
                        {/* <Grid item>
